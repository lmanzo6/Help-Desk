...
public class Login extends JFrame {
	...
	public Login() {
		...
		btn.addActionListener(new ActionListener() {
			...
			//@supresswarnings because getText method is deprecated
			...
			public void actionPerformed(ActionEvent e) {
				...
				String query = "SELECT * FROM lmanz_users WHERE uname = ? and upass = ?;";
				try (PreparedStatement stmt = conn.getConnection().prepareStatement(query)) {
					...
					if (rs.next()) {
						...
						new Tickets(chkIfAdmin); //open Tickets file / GUI interface
